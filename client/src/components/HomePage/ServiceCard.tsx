...
const ServiceCard: React.FC<ServiceCardProps> = ({ image, title }) => {
  return (
    <Link to="#">
      <div className="flex flex-col w-[240px] h-[150px] items-center justify-start p-6 bg-white rounded-2xl shadow-md border  border-gray-200 hover:shadow-lg hover:shadow-gray-700 mb-[10px]">
